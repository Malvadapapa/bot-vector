...
exports.DashboardPanelService = void 0;
class DashboardPanelService {
    constructor(banWarningSystem, loggingService) {
        this.banWarningSystem = banWarningSystem;
     ...
     */
    formatUserInfoPanel(userId, username, infractions = 0, isBanned = false) {
...
exports.DashboardPanelService = DashboardPanelService;
