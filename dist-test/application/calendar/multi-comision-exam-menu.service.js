...
exports.MultiComisionExamMenuService = void 0;
const comision_management_service_js_1 = require("./comision-management.service.js");
class MultiComisionExamMenuService {
    constructor() {
        this.menuStateByUser = new Map();
        this.examComisionsByUser = new Map();
        this.comisionManagementService = new comision_management_service_js_1.ComisionManagementService();
    }
    /**
     * Inicia flujo de examen multi-comisión
     */
    startMultiComisionFlow(userId) {
     ...
     */
    processMultiComisionInput(userId, input) {
...
exports.MultiComisionExamMenuService = MultiComisionExamMenuService;
