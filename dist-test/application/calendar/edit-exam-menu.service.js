...
exports.EditExamMenuService = void 0;
class EditExamMenuService {
    ...
    async processInput(userId, input) {
        ...
        if (state.stage === 'selecting-field') {
            ...
            const currentValue = state.currentExam[state.selectedField] || '(vacío)';
    ...
    normalizeAvailability(value) {
        ...
        if (normalized === '1' || normalized === 'hora-especifica')
            return 'hora-especifica';
        if (normalized === '2' || normalized === 'franja')
            return 'franja';
        return 'a-partir-de';
    }
}
exports.EditExamMenuService = EditExamMenuService;
