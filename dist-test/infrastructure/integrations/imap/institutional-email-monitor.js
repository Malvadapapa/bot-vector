...
exports.InstitutionalEmailMonitor = void 0;
const crypto_1 = __importDefault(require("crypto"));
class InstitutionalEmailMonitor {
    constructor(emailService, noticeRepository, reminderRepository, publishCallback, getTargetGroupId) {
        this.emailService = emailService;
        this.noticeRepository = noticeRepository;
        this.reminderRepository = reminderRepository;
        this.publishCallback = publishCallback;
        this.getTargetGroupId = getTargetGroupId;
    }
    async pollOnce() {
    ...
    parseNoticeFromEmail(email) {
        const subject = (email.subject || '').trim();
        if (!subject.toLowerCase().includes('!aviso'))
            return null;
        ...
        const uniqueHash = crypto_1.default.createHash('sha256').update(uniqueInput).digest('hex');
        return {
            title,
            body: bodyText,
            startDate,
    ...
    buildNaturalMessage(title, body, endDate, eventTime) {
...
exports.InstitutionalEmailMonitor = InstitutionalEmailMonitor;
