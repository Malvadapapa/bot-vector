...
import { BannedUser, InfractionRecord } from './moderation.models.js';
...
export class BanWarningSystem {
  ...
  constructor() {
    ...
    this.intervalId = setInterval(() => this.cleanupRestrictions(), 60000);
  }

  // Helper method for unit tests to clean up interval
  destroy(): void {
    if (this.intervalId) {
