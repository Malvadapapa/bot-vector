...
import { InstitutionalNotice, ManagedExam, Reminder } from '../../domain/models.js';
import { InstitutionalNoticeRepository, ManagedExamRepository, ReminderRepository } from '../../infrastructure/persistence/db/repositories.js';
